...
# Instalamos OpenSSL para generar certificados
...
# Generamos certificados autofirmados
RUN openssl req -x509 -newkey rsa:4096 -keyout /app/certs/tls/private-key.pem \
    -out /app/certs/tls/public-key.pem -days 365 -nodes \
    -subj "/CN=localhost" && \
    cp /app/certs/tls/public-key.pem /app/certs/tls/ca-cert.pem && \
    chmod 600 /app/certs/tls/*.pem && \
    ls -la /app/certs/tls/
